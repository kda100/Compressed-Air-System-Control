...
excel workbook called 'cs2_op2_2018_results.xlsx' located in the same directory as the script.
...
for row in range(1,8257):
    ...
    compressors = [C1, C2, C3, C4, C5, C6] #compressor objects list
    s3 = compressors[0].maximum_flow + compressors[1].maximum_flow #setpoint
    s4 = compressors[0].maximum_flow + compressors[3].maximum_flow #setpoint
    ...
    compressors = [C1, C2, C3, C4, C5, C6] #compressor objects list
    s4 = compressors[0].maximum_flow + compressors[3].maximum_flow #setpoint
    s5 = compressors[0].maximum_flow + compressors[1].maximum_flow + compressors[2].maximum_flow #setpoint
    ...
    compressors = [C1, C2, C3, C4, C5, C6] #compressor objects list
    s5 = compressors[0].maximum_flow + compressors[1].maximum_flow + compressors[2].maximum_flow #setpoint
    s6 = compressors[0].maximum_flow + compressors[1].maximum_flow + compressors[3].maximum_flow #setpoint
    ...
    compressors = [C1, C2, C3, C4, C5, C6] #compressor objects list
    s6 = compressors[0].maximum_flow + compressors[1].maximum_flow + compressors[3].maximum_flow #setpoint
    s7 = compressors[0].maximum_flow + compressors[1].maximum_flow + compressors[2].maximum_flow + compressors[3].maximum_flow #setpoint
    ...
    compressors = [C1, C2, C3, C4, C5, C6] #compressor objects list
    s7 = compressors[0].maximum_flow + compressors[1].maximum_flow + compressors[2].maximum_flow + compressors[3].maximum_flow #setpoint
    s8 = compressors[0].maximum_flow + compressors[1].maximum_flow + compressors[2].maximum_flow + compressors[3].maximum_flow + compressors[5].maximum_flow #setpoint
    ...
    compressors = [C1, C2, C3, C4, C5, C6] #compressor objects list
    s8 = compressors[0].maximum_flow + compressors[1].maximum_flow + compressors[2].maximum_flow + compressors[3].maximum_flow + compressors[5].maximum_flow #setpoint
    s9 = compressors[0].maximum_flow + compressors[1].maximum_flow + compressors[2].maximum_flow + compressors[3].maximum_flow + compressors[5].maximum_flow + compressors[4].maximum_flow #setpoint
...
Control_Scheme_Results = openpyxl.load_workbook('cs2_op2_2018_results.xlsx') #opens results workbook in current directory
...
Control_Scheme_Results.save('cs2_op2_2018_results.xlsx') #saves results workbook

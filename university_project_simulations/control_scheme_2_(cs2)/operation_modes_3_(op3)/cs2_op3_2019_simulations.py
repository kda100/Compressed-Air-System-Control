...
excel workbook called 'cs2_op3_2019_results.xlsx' located in the same directory as the script.
...
Control_Scheme_Results = openpyxl.load_workbook('cs2_op3_2019_results.xlsx') #opens results workbook in current directory

...
C1 = LoadUnload(125, 947) #create LoadUnload compressor object for C1
C2 = LoadUnload(125, 947) #create LoadUnload compressor object for C2
C3 = LoadUnload(125, 947) #create LoadUnload compressor object for C3
C4 = LoadUnload(177, 1326) #create LoadUnload compressor object for C4
C5 = VariableSpeed(384, 2604) #create Variable compressor object for C5
C6 = LoadUnload(274, 1902) #create LoadUnload compressor object for C6
...
Control_Scheme_Results = openpyxl.load_workbook('opt_op2_2019_results.xlsx') #opens results workbook in current directory
...
Control_Scheme_Results.save('opt_op2_2019_results.xlsx') #saves results workbook

...
excel workbook called 'cs1_op2_2018_results.xlsx' located in the same directory as the script.
...
s2-s3                        [C1, C2, C5]
s3-s4                        [C1, C2, C3, C5]
s4-s5                        [C1, C2, C3, C4, C5]
s5-s6                        [C1, C2, C3, C6, C5]
s6-s7                        [C1, C2, C3, C4, C6, C5]
...
for row in range(1,8257):
    ...
    compressors = [C1, C2, C3, C4, C5, C6] #compressor objects list
    s2 = compressors[0].maximum_flow + compressors[1].maximum_flow #setpoint
    s3 = compressors[0].maximum_flow + compressors[1].maximum_flow + compressors[2].maximum_flow #setpoint
    ...
    compressors = [C1, C2, C3, C4, C5, C6] #compressor objects list
    s3 = compressors[0].maximum_flow + compressors[1].maximum_flow + compressors[2].maximum_flow #setpoint
    s4 = compressors[0].maximum_flow + compressors[1].maximum_flow + compressors[2].maximum_flow + compressors[3].maximum_flow #setpoint
    ...
    if s3<air_demand<=s4: #boundary
        ...
        control_input = True #control input for compressor.power_output and compressor.air_output
        CC1_power_output.append(C1.power_output(control_input, air_demand, active_compressors)) #appends C1 power output reading to C1_power_output list
        C1_air_output.append(C1.air_output(control_input, air_demand, active_compressors)) #appends C1 air output reading to C1_air_output list
        C2_power_output.append(C2.power_output(control_input, air_demand, active_compressors)) #appends C2 power output reading to C2_power_output list
        C2_air_output.append(C2.air_output(control_input, air_demand, active_compressors)) #appends C2 air output reading to C2_air_output list
        C3_power_output.append(C3.power_output(control_input, air_demand, active_compressors)) #appends C3 power output reading to C3_power_output list
        ...
        C4_air_output.append(C4.air_output(control_input, air_demand, active_compressors)) #appends C4 air output reading to C4_air_output list
        C6_power_output.append(C6.power_output(control_input, air_demand, active_compressors)) #appends C6 power output reading to C6_power_output list
        C6_air_output.append(C6.air_output(control_input, air_demand, active_compressors)) #appends C6 air output reading to C6_air_output 
        
    compressors = [C1, C2, C3, C4, C5, C6] #compressor objects list
    s4 = compressors[0].maximum_flow + compressors[1].maximum_flow + compressors[2].maximum_flow + compressors[3].maximum_flow #setpoint
    s5 = compressors[0].maximum_flow + compressors[1].maximum_flow + compressors[2].maximum_flow + compressors[5].maximum_flow #setpoint
        
    if s4<air_demand<=s5: #boundary
        active_compressors = [compressors[0], compressors[1], compressors[2], compressors[3], compressors[4]] #active_compressors for compressor.power_output and compressor.air_output
        control_input = True #control input for compressor.power_output and compressor.air_output
       C1_power_output.append(C1.power_output(control_input, air_demand, active_compressors)) #appends C1 power output reading to C1_power_output list
        C1_air_output.append(C1.air_output(control_input, air_demand, active_compressors)) #appends C1 air output reading to C1_air_output list
        C2_power_output.append(C2.power_output(control_input, air_demand, active_compressors)) #appends C2 power output reading to C2_power_output list
    ...
    compressors = [C1, C2, C3, C4, C5, C6] #compressor objects list
    s5 = compressors[0].maximum_flow + compressors[1].maximum_flow + compressors[2].maximum_flow + compressors[5].maximum_flow #setpoint
    s6 = compressors[0].maximum_flow + compressors[1].maximum_flow + compressors[2].maximum_flow + compressors[3].maximum_flow + compressors[5].maximum_flow #setpoint
    ...
    if s5<air_demand<=s6: #boundary
        ...
        control_input = True #control input for compressor.power_output and compressor.air_output
        C1_power_output.append(C1.power_output(control_input, air_demand, active_compressors))
        C1_air_output.append(C1.air_output(control_input, air_demand, active_compressors))
        C2_power_output.append(C2.power_output(control_input, air_demand, active_compressors))
        C2_air_output.append(C2.air_output(control_input, air_demand, active_compressors))
        C3_power_output.append(C3.power_output(control_input, air_demand, active_compressors))
        C3_air_output.append(C3.air_output(control_input, air_demand, active_compressors))
        C5_power_output.append(C5.power_output(control_input, air_demand, active_compressors))
        C5_air_output.append(C5.air_output(control_input, air_demand, active_compressors))
        C6_power_output.append(C6.power_output(control_input, air_demand, active_compressors))
        C6_air_output.append(C6.air_output(control_input, air_demand, active_compressors))
        control_input = False #control input for compressor.power_output and compressor.air_output
        C4_power_output.append(C4.power_output(control_input, air_demand, active_compressors))
        C4_air_output.append(C4.air_output(control_input, air_demand, active_compressors))
        
    compressors = [C1, C2, C3, C4, C5, C6] #compressor objects list
    s6 = compressors[0].maximum_flow + compressors[1].maximum_flow + compressors[2].maximum_flow + compressors[3].maximum_flow + compressors[5].maximum_flow
    s7 = compressors[0].maximum_flow + compressors[1].maximum_flow + compressors[2].maximum_flow + compressors[3].maximum_flow + compressors[5].maximum_flow + compressors[4].maximum_flow
    
    if s6<air_demand<=s7:
        active_compressors = [compressors[0], compressors[1], compressors[2], compressors[3], compressors[5], compressors[4]]
        control_input = True #control input for compressor.power_output and compressor.air_output
        C1_power_output.append(C1.power_output(control_input, air_demand, active_compressors)) #appends C1 power output reading to C1_power_output list
        C1_air_output.append(C1.air_output(control_input, air_demand, active_compressors)) #appends C1 air output reading to C1_air_output list
        C2_power_output.append(C2.power_output(control_input, air_demand, active_compressors)) #appends C2 power output reading to C2_power_output list
...
Control_Scheme_Results = openpyxl.load_workbook('cs1_op2_2018_results.xlsx') #opens results workbook in current directory
...
Control_Scheme_Results.save('cs1_op2_2018_results.xlsx') #saves results workbook

...
and 'compressors_air_output' in an excel workbook called 'opt_op1_2018_results.xlsx' located in the same directory as the script.
...
Control_Scheme_Results = openpyxl.load_workbook('opt_op2_2018_results.xlsx') #opens results workbook in current directory
...
Control_Scheme_Results.save('opt_op2_2018_results.xlsx') #saves results workbook

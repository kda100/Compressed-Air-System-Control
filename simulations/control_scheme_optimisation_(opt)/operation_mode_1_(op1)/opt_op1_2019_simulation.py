...
Control_Scheme_Results = openpyxl.load_workbook('opt_op1_2019_results.xlsx') #opens results workbook in current directory
...
Control_Scheme_Results.save('opt_op1_2019_results.xlsx') #saves results workbook

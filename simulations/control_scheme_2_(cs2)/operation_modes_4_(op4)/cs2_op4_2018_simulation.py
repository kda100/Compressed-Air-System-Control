...
excel workbook called 'cs2_op4_2018_results.xlsx' located in the same directory as the script.
...
Control_Scheme_Results = openpyxl.load_workbook('cs2_op4_2018_results.xlsx') #opens results workbook in current directory
...
Control_Scheme_Results.save('cs2_op4_2018_results.xlsx') #saves results workbook

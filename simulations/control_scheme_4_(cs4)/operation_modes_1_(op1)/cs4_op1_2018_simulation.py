...
excel workbook called 'cs4_op1_2018_results.xlsx' located in the same directory as the script.
...
C5 = cm1.VariableSpeed(384, 2604) #create Variable compressor object for C5
